...
const Process = () => {
    ...
    return (
        <div className='min-h-screen flex flex-col items-center justify-center' id='services'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-7 lg:w-10/12 mt-10'>
                {process.map((proces, index) => (
                    <div key={index} data-aos={proces.aos} className='bg-cardBg py-5 px-6 border border-border flex flex-col text-left rounded-[30px] gap-2 relative'>
