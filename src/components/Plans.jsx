...
const Plans = () => {
    ...
    return (
        <div className='flex flex-col items-center justify-center min-h-screen' id='plans'>
            ...
            <div class="inline-flex bg-cardBg border my-4 p-1 rounded-lg text-cardContent text-primaryText border-border space-x-3" role="group">
                <button
                    type="button"
            ...
            <section className='grid lg:grid-cols-3 sm:grid-cols-1 gap-8 lg:w-5/6 text-primaryText text-bodyS '>
                ...
                {plan.map((plans) => {
                    ...
                    return (
                        <div className="mt-3 plan_card relative  " >
                            ...
                            <div className='space-y-4'>
                                ...
                                <p className='text-secondaryText '>{plans.text}</p></div>
                            <SolideBtn className="w-full"> Get in touch</SolideBtn>
                            <ul className="text-left space-y-2 mb-6">
                                {plans.list.map((item, i) => (
                                    <li key={i} className="flex items-center gap-2 ">
                                        <span className='flex justify-items-center items-center  '> <HiCheck className='icon text-2xl mr-2' />{item}</span>
                                    </li>
                                ))}
                            </ul>
