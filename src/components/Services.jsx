    ...
    <div className='min-h-screen flex flex-col items-center ' id='services'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-6 gap-4 lg:w-10/12'>
        {service.map((srv, index) => (
          <div key={index} data-aos={srv.aos} className={`bg-cardBg py-5 px-8 border border-border flex flex-col text-left rounded-lg gap-5 ${index < 3 ? 'col-span-2' : 'col-span-3'}`}>
